...
// find a particular fbclub by name (or other search criteria)
...
module.exports = {
  ...
  search: {
    display: {
      label: 'Find Fbclub',
      description: 'Finds a fbclub give.'
    },
    operation: {
      inputFields: [
  ...
  create: {
    display: {
      label: 'Create Fbclub',
      description: 'Creates a new fbclub.'
    },
    operation: {
      inputFields: [
        {key: 'name', required: true}
