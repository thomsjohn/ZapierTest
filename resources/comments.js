...
// find a particular comments by name (or other search criteria)
...
module.exports = {
  ...
  list: {
    display: {
      label: 'New Comments',
      description: 'Lists the commentss.'
    },
    operation: {
      inputFields: [
        {
          key: 'name', 
          required: true,
          helpText: 'Name of the comments',
        },
        {
          key: 'email',
          required: false,
          helpText: 'Email of the comments',
        },
        {
          key: 'body',
          helpText: 'Body of the commeents',
        },
      ],
      perform: performList,
  ...
  search: {
    display: {
      label: 'Find Comments',
      description: 'Finds a comments give.'
    },
    operation: {
      inputFields: [
